package com.yashtech.weatherit;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getWeatherInfo(String cityName) {
        String apiKey = "95965744e324439a9b7153521240401";
        String url = "https://api.weatherapi.com/v1/forecast.json?key=" + apiKey + "&q=" + cityName + "&days=1&aqi=no&alerts=no";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    String imageUrl = (isDay == 1) ?
                            "https://unsplash.com/photos/blue-and-white-abstract-painting-r6UY109iJBA" :
